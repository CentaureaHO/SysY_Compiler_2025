...
Block2: ; Loop 0 header
	%reg_240 = phi i32 [ %reg_3, %Block19 ], [ %reg_243, %Block7 ]
	br label %Block3
Block3: ; Loop 0 body
	%reg_14 = getelementptr [5 x i32], ptr %reg_2, i32 0, i32 %reg_5
	%reg_15 = add i32 2, 0
	store i32 %reg_15, ptr %reg_14
	br label %Block20
Block4: ; Loop 0 exit target
	%reg_242 = phi i32 [ %reg_243, %Block7 ], [ %reg_3, %Block19 ]
	%reg_231 = add i32 5, 0
...
Block5: ; Loop 0 body
	...
	br label %Block6
Block6: ; Loop 0 body
	%reg_22 = getelementptr [5 x i32], ptr %reg_2, i32 0, i32 %reg_15
	store i32 %reg_5, ptr %reg_22
	br label %Block21
Block7: ; Loop 0 latch
	%reg_243 = phi i32 [ %reg_244, %Block10 ], [ %reg_240, %Block20 ]
	%reg_228 = load i32, ptr %reg_4
	%reg_230 = add i32 %reg_228, %reg_5
...
Block15: ; Loop 0 body
	...
	%reg_65 = sub i32 %reg_47, %reg_5
	%reg_70 = sub i32 %reg_50, %reg_15
	%reg_75 = sub i32 %reg_53, %reg_5
	%reg_80 = sub i32 %reg_56, %reg_29
	%reg_85 = sub i32 %reg_59, %reg_5
	...
	%reg_97 = sub i32 %reg_50, %reg_5
	%reg_107 = sub i32 %reg_56, %reg_5
