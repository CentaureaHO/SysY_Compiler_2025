...
define i32 @sub(ptr %reg_0, ptr %reg_1, ptr %reg_2, ptr %reg_3, ptr %reg_4, ptr %reg_5, ptr %reg_6, ptr %reg_7, ptr %reg_8)
{
...
Block3:  ;While body at line 9
	...
	%reg_23 = fsub float %reg_19, %reg_22
	...
	%reg_32 = fsub float %reg_28, %reg_31
	...
	%reg_41 = fsub float %reg_37, %reg_40
...
Block4:  ;While end at line 29
	...
	%reg_54 = call i32 @sub(ptr %reg_45, ptr %reg_46, ptr %reg_47, ptr %reg_48, ptr %reg_49, ptr %reg_50, ptr %reg_51, ptr %reg_52, ptr %reg_53)
	store i32 %reg_54, ptr %reg_12
	%reg_56 = add i32 0, 0
	store i32 %reg_56, ptr %reg_55
	br label %Block5
Block5:  ;While condition at line 41
	%reg_57 = load i32, ptr %reg_12
	%reg_58 = add i32 3, 0
	%reg_59 = icmp slt i32 %reg_57, %reg_58
	br i1 %reg_59, label %Block6, label %Block7
Block6:  ;While body at line 41
