...
namespace LLVMIR
{
    ...
    class Instruction
    {
      public:
        ...
        virtual bool         SubstituteOperands(const std::map<int, Operand*>& substitutions) = 0;
    ...
    class LoadInst : public Instruction
    {
      public:
        ...
        virtual bool                  SubstituteOperands(const std::map<int, Operand*>& substitutions) override;
