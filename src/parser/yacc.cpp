...
#line 540 "parser/yacc.y"
        ...
        */
        ...
        {
            yylhs.value.as < ExprNode* > () = new FuncCallExpr(Symbol::Entry::getEntry(funcName), nullptr);
        }
        else
        {
...
#undef YYCASE_
   ...
   Parser ::yyrline_[] =
  {
     ...
     510,   516,   519,   525,   528,   531,   534,   540,   566,   573,
     579,   583,   590,   595,   603,   608,   613,   618,   626,   629,
     632,   638,   641,   644
  };
